...
ALTER TABLE public.user_preferences
ADD COLUMN notification_preferences jsonb DEFAULT '{"new_challenges": true, "circle_messages": true, "app_updates": true}'::jsonb;

-- Add preferred_interaction_times to user_preferences table
ALTER TABLE public.user_preferences
ADD COLUMN preferred_interaction_times jsonb DEFAULT '{"morning": true, "afternoon": true, "evening": true}'::jsonb;
